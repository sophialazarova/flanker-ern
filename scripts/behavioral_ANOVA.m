...
meanmat = csvread([PATHIN '/rt_meanmat.csv']);
...
% figure;
% boxplot([table.incong_corr+table.incong_incorr,table.cong_corr+table.cong_incorr], {'Incongruent', 'Congruent'})
% hold on
% plot(1, mean(table.incong_corr+table.incong_incorr), 'dg')
% plot(2, nanmean(table.cong_corr+table.cong_incorr), 'dg')
% hold off
